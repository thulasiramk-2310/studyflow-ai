            ...
            <div className="bg-surface border border-border rounded-2xl p-5 shadow-[0_1px_2px_rgba(15,23,42,0.04)]">
              ...
              <div className="grid grid-cols-2 gap-3.5">
                ...
                <div>
                  ...
                  <input defaultValue="ada.okafor@university.edu" className="w-full px-3.5 py-2.5 border border-border rounded-lg text-sm bg-background outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all" />
                </div>
              </div>
